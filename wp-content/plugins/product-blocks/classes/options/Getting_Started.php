           ...
           <div class="wopb-admin-sidebar">
                        <?php if (!wopb_function()->isActive()) { ?>
                            <div class="wopb-sidebar wopb-admin-card">
                                ...
                                <a href="<?php echo esc_url(wopb_function()->get_premium_link("https://www.wpxpo.com/productx/pricing/", 'menu_started_upgrade_pro')); ?>" target="_blank" class="wopb-btn wopb-btn-primary wopb-btn-pro"><?php esc_html_e('Upgrade to Pro  ➤', 'product-blocks'); ?></a>
                            </div>
                            <?php } ?>
