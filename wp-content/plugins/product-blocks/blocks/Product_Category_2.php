    ...
    public function get_attributes($default = false){
        ...
        $attributes = array(
            ...
            'columnGridGap' => [
                ...
                'style' => [
                    (object)[
                        'selector'=>'{{WOPB}} .wopb-block-items-wrap { grid-gap: {{columnGridGap}}; }'
                    ],
                ],
            ],
            ...
            'titleTypo' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{WOPB}} .wopb-block-item .wopb-product-cat-title, {{WOPB}} .wopb-block-item .wopb-product-cat-title a'
                    ],
                ],
            ],
            'titleColor' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{WOPB}} .wopb-block-item .wopb-product-cat-title a { color:{{titleColor}}; }'
                    ],
                ],
            ],
            'titleHoverColor' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{WOPB}} .wopb-block-item .wopb-product-cat-title a:hover { color:{{titleHoverColor}}; }'
                    ],
                ],
            ],
            'titlePadding' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{WOPB}} .wopb-block-item .wopb-product-cat-title { padding:{{titlePadding}}; word-wrap: break-word;}'
                    ],
                ],
            ],
            ...
            'ShortDescColor' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{WOPB}} .wopb-block-item .wopb-product-cat-desc { color:{{ShortDescColor}}; }'
                    ],
                ],
            ],
            'ShortDescPadding' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{WOPB}} .wopb-block-item .wopb-product-cat-desc { padding:{{ShortDescPadding}}; }'
                    ],
                ],
            ],
            ...
            'categoryrCountTypo' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{WOPB}} .wopb-category-content-item .wopb-product-cat-count'
                    ],
                ],
            ],
            'categoryrCountColor' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{WOPB}} .wopb-category-content-item .wopb-product-cat-count { color:{{categoryrCountColor}}; }'
                    ],
                ],
            ],
            'categoryrCountPadding' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{WOPB}} .wopb-category-content-item .wopb-product-cat-count { padding:{{categoryrCountPadding}}; }'
                    ],
                ],
            ],
            ...
            'imgWidth' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{WOPB}} .wopb-block-item .wopb-block-image { width: {{imgWidth}}; }'
                    ],
                ],
            ],
            'imgHeight' => [
                ...
                'style' => [
                    (object)[
                        ...
                        'selector'=>'{{WOPB}} .wopb-block-item .wopb-block-image img , {{WOPB}} .wopb-block-item .wopb-block-image-empty { height: calc({{imgHeight}}/2); }'
                        // 'selector'=>'{{WOPB}} .wopb-block-item .wopb-block-image , {{WOPB}} .wopb-block-item .wopb-block-image-empty { height: calc({{imgHeight}}/2); }'
                    ],
                ],
            ],
            'imageScale' => [
    ...
    public function register() {
        register_block_type( 'product-blocks/product-category-2',
            array(
                ...
                'title' => __('Product Category #2', 'product-blocks'),
                        ...
                        foreach ($recent_posts as $value) {
                            $post_loop .= '<div class="wopb-block-item">';
                                $post_loop .= '<div class="wopb-block-content-wrap">';
                                    if( $attr['showImage'] ){
                                        if( $value['image'] ) {
                                        $post_loop .= '<div class="wopb-block-image wopb-block-image-'.esc_attr($attr['imgAnimation']).'"><a href="'.esc_url($value['url']).'" class="wopb-product-cat-img"><img src='.esc_url($value['image'][$image_size]).' alt='.esc_html($value['name']).'/></a></div>';
                                        } else {
